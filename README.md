...
## Editing WWOO
### Datapack / Mod below version 2.6.0
1. Open the file with 7zip or a similiar tool. 
2. Locate the biome or other files you want to edit. E.g. biome files are located at ```data/minecraft/worldgen/biome/```.
3. Edit the files or even delete them.
